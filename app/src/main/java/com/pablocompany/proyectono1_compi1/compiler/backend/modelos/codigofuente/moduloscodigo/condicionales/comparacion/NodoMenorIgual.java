...
//Clase que representa al operador de comparacion menor o igual que
public class NodoMenorIgual extends Nodo {
    //Atributos
    Nodo expresionA;
    Nodo expresionB;

    public NodoMenorIgual( Nodo expA, Nodo expB,int linea, int columna) {
        super(linea, columna);
        this.expresionA = expA;
        this.expresionB = expB;
    }

    //Metodo que permite validar semantica de Menor o igual  (PATRON EXPERTO)
    @Override
    public TipoVariable validarSemantica(TablaSimbolos tabla, List<ErrorAnalisis> listaErrores) {
        ...
        listaErrores.add(new ErrorAnalisis("Menor o igual", "Semantico",
    ...
    //Expresion que permite evaluar el operador logico menor o igual
    @Override
    public Object ejecutar(TablaSimbolos tabla, List<ErrorAnalisis> listaErrores) {
        ...
        listaErrores.add(new ErrorAnalisis(
                this.getString(),
                "Semántico",
                "Los operandos deben ser ambos numéricos o ambos strings para la comparación \"menor o igual\".",
                this.getLinea(),
                this.getColumna()));
